---
title: "Trendfolge-Strategien: Die meistunterschätzte Form des Tradings"
...
Drei strukturelle Gründe erklären, warum Trendfolge über Jahrzehnte profitabel war:

**1. Verhaltensökonomische Anomalien.** Marktteilnehmer reagieren systematisch zu langsam auf neue Informationen. Eine Fed-Zinsentscheidung wird nicht in Sekunden eingepreist, sondern über Wochen verarbeitet. Diese Trägheit schafft Trends.

**2. Herding-Effekt.** Wenn Preise steigen, kommen neue Käufer hinzu, die den Trend verstärken. Wenn Preise fallen, lösen Stop-Losses und Margin-Calls weitere Verkäufe aus. Selbstverstärkende Dynamiken.

**3. Informations-Asymmetrie.** Institutionelle Akteure bauen grosse Positionen oft über Wochen oder Monate auf. Wer einem solchen Aufbauprozess folgt, profitiert von der späteren öffentlichen Bewegung.
...
- 60 bis 70 % der Trades sind Verluste oder kleine Gewinne
- 20 bis 30 % der Trades sind moderate Gewinne
- 5 bis 10 % der Trades sind die "Home Runs", die das Jahr machen
...
**Man AHL, Winton, Renaissance Technologies (Medallion):** Moderne quantitative Hedgefonds, die in Variationen Trendfolge-Prinzipien anwenden.

## Klassische Umsetzungen

### Donchian-Channel

Der einfachste Trendfolge-Ansatz: Kaufe, wenn der Preis das Hoch der letzten N Tage überschreitet. Verkaufe, wenn er das Tief der letzten N Tage unterschreitet.
...
Die ursprüngliche Turtle-Strategie kombinierte zwei Systeme:
- System 1: 20-Tage-Breakout für Eintritt, 10-Tage-Gegenrichtung für Ausstieg
- System 2: 55-Tage-Breakout für Eintritt, 20-Tage-Gegenrichtung für Ausstieg
...
Fast alle Privatanleger scheitern an Trendfolge aus den gleichen Gründen:

**Fehler 1: Zu kurze Beobachtungszeiträume.** Eine Trendfolge-Strategie braucht 2 bis 5 Jahre, um ihren statistischen Vorteil zu zeigen. Wer nach drei Monaten Verlust aufgibt, hat nichts gelernt.

**Fehler 2: Optimierung am historischen Backtest.** Wer Parameter so lange anpasst, bis die Historie perfekt aussieht, hat ein Overfitting-Problem. Out-of-Sample funktioniert solche Optimierung selten.

**Fehler 3: Zu wenige Märkte.** Trendfolge auf einem einzigen Markt (z.B. nur SPX) hat Phasen von zwei bis drei Jahren ohne sinnvolle Bewegung. Diversifikation ist nicht optional.
...
Die akademische und institutionelle Forschung der letzten zwanzig Jahre hat Trendfolge weitgehend validiert. Studien zeigen konsistent:
