...
**Im Wertschriftenverzeichnis erfasst**:
- Bankkonten (Lohnkonto, Sparkonto, Tagesgeld)
- Aktien (Schweizer und ausländische)
...
- Auto (oft pauschal bewertet)
- Lebensversicherungen mit Rückkaufswert
- Säule 3a (in einigen Kantonen separat behandelt)
- Edelmetalle (Gold, Silber)
- Bargeld zu Hause

**Nicht zum Vermögen**:
- Hausrat im normalen Umfang
- Persönliche Gebrauchsgegenstände
- Pensionskasse (Säule 2, vor Bezug)
...
**Immobilien**: Zum **Steuerwert**, der oft 60-90% des Verkehrswerts beträgt. Das ist eine kantonale Frage und variiert stark.

**Lebensversicherungen**: Zum Rückkaufswert per 31.12.

## Schulden abziehen

Schulden mindern das steuerbare Vermögen:
- Hypotheken (auf Immobilien)
- Konsumkredite
- Geschäftliche Schulden
- Lombardkredite (Wertschriftenkredite)

**Wichtig**: Schulden müssen **abzugsfähig** sein. Privatdarlehen unter Freunden ohne Vertrag werden vom Steueramt skeptisch beurteilt.
...
|--------|----------------------------------|---------------------|
| Zürich | ca. 0,4% | 80.000 CHF |
| Genf | bis 1% | 82.000 CHF |
| Zug | ca. 0,2% | 100.000 CHF |
| Basel-Stadt | bis 0,7% | 50.000 CHF |
| Schwyz | ca. 0,15% | 100.000 CHF |
| Nidwalden | ca. 0,2% | 50.000 CHF |
...
- Kantonale Vermögenssteuer: ca. 0,2% durchschnittlich = 1.000 CHF
- Kommunale Steuer: Multiplikator (oft 90-130%) = ca. 1.100 CHF
- **Total Vermögenssteuer: ca. 2.100 CHF**
...
- Dieser Betrag wird im Wertschriftenverzeichnis erfasst und unterliegt der Vermögenssteuer

Auch wenn du die Aktien nie verkaufst und niemals einen Gewinn realisierst, zahlst du jährlich Vermögenssteuer auf den steigenden Marktwert.
...
Kryptowährungen müssen im Wertschriftenverzeichnis erfasst werden. Die ESTV publiziert Jahresendkurse für die wichtigsten Coins:
- Bitcoin
- Ethereum
- weitere Top-Coins
...
## Vermögenssteuer bei Aktien-Crashs
...
**Deutschland**: Keine Vermögenssteuer. Diskussion über Wiedereinführung gibt es immer wieder, aktuell aber nicht umgesetzt.

**Österreich**: Keine Vermögenssteuer mehr seit 1994.
