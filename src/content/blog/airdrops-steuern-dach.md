---
title: "Airdrops und Steuern: Wie kostenlose Token in der Schweiz und Deutschland behandelt werden"
description: "Sind Airdrops steuerpflichtig? Die unterschiedliche Behandlung in der Schweiz und Deutschland, je nachdem ob eine Gegenleistung erbracht wurde."
pubDate: 2026-11-23
category: "Krypto"
subcategory: "Steuern"
author: "Redaktion"
...
Ein Airdrop ist die kostenlose Verteilung von Token an Wallet-Inhaber. Projekte nutzen das, um Aufmerksamkeit zu erzeugen, frühe Nutzer zu belohnen oder ein neues Token zu verbreiten. Manchmal erhält man sie einfach fürs Halten einer bestimmten Kryptowährung, manchmal für aktive Teilnahme (etwa Tests, Werbung, Aufgaben).

Genau diese Unterscheidung, geschenkt oder für eine Leistung, ist steuerlich der Schlüssel.

## Schweiz: meist Einkommen zum Marktwert
...
| Szenario | Schweiz | Deutschland |
|----------|---------|-------------|
| Airdrop ohne Gegenleistung | Meist Einkommen | Nicht steuerpflichtig beim Zufluss |
| Airdrop mit Gegenleistung | Einkommen | Sonstige Einkünfte |
| Späterer Verkauf | Privat steuerfrei | Steuerfrei nach 1 Jahr |

## Das Bewertungsproblem

Eine praktische Schwierigkeit bei Airdrops ist die **Bewertung**. Frisch verteilte Token haben oft noch keinen etablierten Marktpreis, manchmal sind sie zunächst gar nicht handelbar.

In solchen Fällen ist eine plausible Bewertung gefragt, etwa der erste verfügbare Handelskurs. Wichtig ist die Dokumentation: Datum des Erhalts, Menge und der zugrunde gelegte Wert sollten festgehalten werden.

## Der häufige Irrtum

Viele Anleger gehen davon aus, dass alles "Geschenkte" steuerfrei sei. Das stimmt so nicht, weder in der Schweiz (wo Airdrops meist Einkommen sind) noch vollständig in Deutschland (wo es auf die Gegenleistung ankommt). Wer Airdrops einfach ignoriert, riskiert eine unvollständige Steuererklärung.

## Fazit

Airdrops sind steuerlich kein Selbstläufer, und die Behandlung unterscheidet sich zwischen den Ländern deutlich:

1. **In der Schweiz** meist Einkommen zum Marktwert am Zuflusstag
2. **In Deutschland** kommt es darauf an, ob eine Gegenleistung erbracht wurde
3. **Die erhaltenen Token** gehören anschliessend zum Vermögen
4. **Dokumentation** von Datum, Menge und Wert ist entscheidend

Wer regelmässig Airdrops erhält, sollte sie konsequent erfassen, "gratis" bedeutet steuerlich eben nicht automatisch "steuerfrei".

---

*Dieser Artikel ist eine redaktionelle Einschätzung und ersetzt keine individuelle Steuerberatung. Die Praxis bei Airdrops entwickelt sich laufend weiter.*
