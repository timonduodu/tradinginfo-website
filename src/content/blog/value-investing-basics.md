---
title: "Value Investing Basics: Wie Buffett und Graham günstige Aktien finden"
description: "Value Investing ist die älteste und am besten dokumentierte Anlagestrategie. Wir erklären die Grundkonzepte, wichtigsten Kennzahlen und die Realität für DACH-Anleger."
pubDate: 2026-07-20
category: "Strategien"
...
- KGV-basierte Methoden: Vergleich mit historischem KGV und Branchenschnitt
...
**ROIC (Return on Invested Capital)**: Wie gut das Unternehmen mit seinem investierten Kapital arbeitet. Buffett bevorzugt Firmen mit hohem ROIC, der konstant über Jahre bleibt.

## Value vs Growth

Value Investing ist das Gegenstück zu Growth Investing:

| | Value | Growth |
|--|-------|--------|
| Fokus | Günstige etablierte Firmen | Schnell wachsende Firmen |
| KGV | Niedrig (z.B. 8-15) | Hoch (z.B. 30-100+) |
| Dividenden | Oft hoch | Meist niedrig oder keine |
...
**Schweiz**: Klassische Value-Werte am SMI sind Versicherer (Zurich Insurance, Swiss Re), Banken (UBS), und Industriewerte (Holcim, Lonza). Roche und Novartis schwanken oft zwischen Value- und Quality-Profil.
...
Wer hier "günstig" kauft, sieht oft nur noch tiefer fallen. Die Kunst ist zu unterscheiden: Ist diese Firma temporär unterbewertet oder strukturell im Niedergang?

## Quality-Faktor: Buffet's Weiterentwicklung
...
Diese "Quality-Value"-Strategie ist heute der Mainstream-Ansatz im professionellen Value Investing.
...
- Buffett: Berkshire-Aktionärsbriefe (online verfügbar)
- Greenblatt: "The Little Book That Still Beats the Market"

## Value Investing in der ETF-Welt

Wer nicht selbst Aktien auswählen will, kann Value-ETFs nutzen:

- **iShares Edge MSCI World Value Factor UCITS ETF**
- **Vanguard Value ETF (USA)**
- **WisdomTree Europe Equity Income UCITS ETF**

Diese kosten 0,2-0,5% TER und liefern systematisches Value-Engagement.
