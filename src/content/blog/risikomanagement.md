---
title: "Risikomanagement im Trading: Die wichtigste Disziplin überhaupt"
...
| Verlust in Prozent | Notwendiger Gewinn zur Erholung |
|---|---|
| -10 % | +11 % |
| -25 % | +33 % |
| -50 % | +100 % |
...
> *"Plan the trade, trade the plan. And the plan must include the exit."*
>, **Richard Wyckoff**
...
| R:R-Verhältnis | Notwendige Trefferquote für Break-Even |
|---|---|
| 1:1 | 50 % |
| 1:2 | 33 % |
| 1:3 | 25 % |
...
| Strategie-Typ | Typischer Max. Drawdown |
|---|---|
| Buy-and-Hold Aktien | 30 bis 50 % |
| Trendfolge | 20 bis 35 % |
| Mean-Reversion | 15 bis 25 % |
| Arbitrage | 5 bis 15 % |
| Hochfrequenz-Trading | unter 5 % |
