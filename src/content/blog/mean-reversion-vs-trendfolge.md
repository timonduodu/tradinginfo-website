...
| Indikator | Funktionsweise |
|-----------|----------------|
| Gleitender Durchschnitt (MA) | 50-/200-Tage MA als Trend-Filter |
| MACD | Trendrichtung und Momentum |
| ADX | Trendstärke |
| Donchian Channels | Ausbruchs-Trading |
| Trendlinien | Visuelle Trend-Identifikation |
...
| Bollinger Bands | Extreme bei +/- 2 Standardabweichungen |
| Z-Score | Wie viele Standardabweichungen vom Mittelwert |
| Spread zu MA | Distanz zum gleitenden Mittel |
| Volatilität | Mean Reversion in Vola selbst |
