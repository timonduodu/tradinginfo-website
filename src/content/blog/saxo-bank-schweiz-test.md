---
title: "Saxo Bank Schweiz Test 2026: Der neue Preisbrecher unter den CH-Brokern?"
description: "Saxo Bank Schweiz hat 2025 die Depotgebühren abgeschafft und positioniert sich als günstigster Schweizer Broker. Wir analysieren Gebühren, Plattform und ob die Versprechen halten."
pubDate: 2026-08-06
category: "Broker"
subcategory: "Schweiz"
...
Saxo Bank ist eine 1992 gegründete dänische Investmentbank, die zu den global führenden Online-Brokern gehört. Die Saxo Bank Schweiz wurde 1997 gegründet und ist eine voll lizenzierte Schweizer Bank mit Sitz in Zürich.

Die wichtigsten Eckdaten:
- **Regulierung**: FINMA, Schweizer Banklizenz
- **Einlagensicherung**: esisuisse bis CHF 100.000
- **Globale Plattform**: Saxo Bank betreut weltweit ca. 1 Million Kunden
- **Asset-Klassen**: Aktien, ETFs, Anleihen, Optionen, Futures, Forex, CFDs, Krypto-ETPs
...
Während [Cornèrtrader](/blog/cornertrader-test) 2026 erstmals Depotgebühren einführt, geht Saxo den umgekehrten Weg.

## Gebührenmodell 2026

### Aktien- und ETF-Handel

Saxo Bank hat ein gestaffeltes Pricing:

| Markt | Mindestgebühr | Prozentual |
|-------|---------------|-------------|
| Schweizer Aktien | CHF 3 | 0,08% |
| Deutsche Aktien | EUR 3 | 0,08% |
...
Optionen: CHF 3 pro Kontrakt (US), EUR 3 (EU)
Futures: CHF/EUR 3 pro Kontrakt

Das ist günstig im professionellen Vergleich, aber nicht so billig wie Interactive Brokers.
...
- Krypto-ETPs (Bitcoin, Ethereum, etc.)

**Plattformen**:
- **SaxoTraderGO**: Web-basiert, intuitiv, für 95% der Anleger ideal
- **SaxoTraderPRO**: Desktop, für aktive Trader mit erweiterten Features
...
**8. Stempelabgabe automatisch**: Saxo zieht die [Stempelabgabe](/blog/schweizer-stempelabgabe) direkt ab und führt sie ab, keine separate Bürokratie.
...
**3. Begrenzte Krypto-Auswahl**: Krypto nur als ETPs oder CFDs, kein direkter Kauf von Coins.

**4. Kein steuereinfacher Handel für DE/AT**: Schweizer Saxo führt keine Kapitalertragsteuer für deutsche oder österreichische Kunden ab.

## Saxo vs Cornèrtrader vs Swissquote: Direkter Vergleich

| Aspekt | Saxo Bank | Cornèrtrader | Swissquote |
|--------|-----------|--------------|------------|
| Banklizenz | CH | CH | CH |
| Min. Trade CH | CHF 3 | CHF 9 | CHF 9 |
| Min. Trade US | USD 1 | USD 9 | USD ~25 |
| Depotgebühr | nein | ja (ab 2026) | nein für CH-Anleger |
| Wechselkursgebühr | 0,25% | 0,5% | 0,95% |
| ETF-Sparpläne gratis | ja (AutoInvest) | nein | nein |
...
|----------|-------------|
| Depotgebühr | CHF 0 |
| 12 Trades × CHF 4 (0,08% von 5000) | CHF 48 |
...
Für aktive Trader gilt: Auch bei Saxo wirst du [gewerbsmässig](/blog/privater-anleger-gewerbsmaessig), wenn du die ESTV-Kriterien erfüllst. Der günstige Broker ändert nichts an dieser Steuersystematik.

## Plattform-Erfahrung: SaxoTraderGO

Die Web-Plattform ist intuitiv aufgebaut:
- Watchlists für deine Lieblings-Aktien
- Order-Ticket mit allen Auftragsarten (Market, Limit, Stop, Trailing Stop)
