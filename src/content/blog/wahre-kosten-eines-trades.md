---
title: "Was kostet ein Trade wirklich? Die versteckten Gebühren beim Aktienkauf"
...
1. **Trading-Gebühr** (offensichtlich)
2. **Spread** (für aktive Trader relevant)
3. **FX-Aufschlag** (grösste versteckte Position)
4. **Stempelabgabe** (CH-spezifisch)
5. **Depotgebühr** (langfristig wichtig)
6. **Quellensteuer** (rückforderbar, aber Aufwand)
